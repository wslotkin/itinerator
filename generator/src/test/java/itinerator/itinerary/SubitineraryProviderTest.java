...
public class SubitineraryProviderTest {
    ...
    private static final Event EVENT_0 = new TestEventBuilder().setEventTime(Range.of(T_0, T_1)).build();
    private static final Event EVENT_1 = new TestEventBuilder().setEventTime(Range.of(T_1, T_2)).build();
    private static final Event EVENT_2 = new TestEventBuilder().setEventTime(Range.of(T_2, T_3)).build();
    private static final Event EVENT_3 = new TestEventBuilder().setEventTime(Range.of(T_3, T_4)).build();
    private static final Event EVENT_4 = new TestEventBuilder().setEventTime(Range.of(T_4, T_5)).build();
    private static final Event EVENT_5 = new TestEventBuilder().setEventTime(Range.of(T_5, T_6)).build();
    private static final Event EVENT_6 = new TestEventBuilder().setEventTime(Range.of(T_6, T_7)).build();
